...
FUND_SECTOR = {
    ...
    "002611": "商品", "001552": "商品",  # 黄金ETF联接
    "161226": "商品",  # 白银LOF
    "003321": "商品", "007844": "商品",  # 原油/大宗商品(QDII)
    # QDII 全球基金
    "050025": "美股", "161125": "美股",   # 标普500
    "270042": "美股", "161130": "美股",   # 纳斯达克100
    "164824": "印度",                      # 工银印度基金
    "008763": "越南",                      # 天弘越南市场
    "000071": "港股",                       # 华夏恒生ETF联接
    "501021": "港股",                      # 港股中小盘
...
# ==================== 资产类别（区域/市场） ====================
# 每只基金归属一个资产类别，用于全球分散化
ASSET_CLASS = {
    # A股
    "161725": "A股", "012414": "A股", "005827": "A股", "004868": "A股",
    "003834": "A股", "001156": "A股", "320007": "A股", "008087": "A股",
    "001714": "A股", "005267": "A股",
    "000961": "A股", "001938": "A股", "002021": "A股", "006098": "A股",
    "001632": "A股", "519736": "A股", "007119": "A股",
    # 美股
    "050025": "美股", "161125": "美股", "270042": "美股", "161130": "美股",
    # 欧洲
    "015016": "欧洲",
    # 新兴市场
    "164824": "新兴市场", "008763": "新兴市场",
    # 港股
    "000071": "港股", "501021": "港股",
    # 商品
    "002611": "商品", "001552": "商品", "161226": "商品",
    "003321": "商品", "007844": "商品",
}

# 资产类别最大占比（防止单一市场过度集中）
ASSET_CLASS_MAX_PCT = 0.40

# 资产类别相关性分组（高相关性归为一组，整体受 ASSET_CLASS_MAX_PCT 约束）
...
# QDII 品种（净值 T+2 公布）
QDII_FUNDS = {
    "110011", "003321", "007844",   # 原有 QDII
    "050025", "161125",             # 标普500
    "270042", "161130",             # 纳斯达克100
    "164824",                       # 印度
    "008763",                       # 越南
    "000071", "501021",             # 港股
}
...
# 商品类基金（与A股低相关性，用于对冲）
COMMODITY_FUNDS = {"002611", "001552", "161226", "003321", "007844"}

# ==================== QDII 单日申购限额（元） ====================
# QDII 基金因外汇额度限制，经常限购。0 或未列出 = 不限制
DAILY_PURCHASE_LIMIT = {
    "050025": 100,      # 博时标普500ETF联接
    "161125": 100,      # 易方达标普500指数
    "270042": 10,       # 广发纳斯达克100ETF联接
    "161130": 100,      # 易方达纳斯达克100ETF联接
    "164824": 100000,   # 工银印度基金（基本不限）
    "008763": 1000,     # 天弘越南市场
}

# ==================== 暂停申购基金（定期更新） ====================
# 暂停申购的基金不参与买入扫描，但持仓可继续持有/卖出
SUSPENDED_FUNDS = {
    "050025",   # 博时标普500 - 暂停申购 (2026-05-28)
    "161125",   # 易方达标普500 - 暂停申购
    "161130",   # 易方达纳斯达克100 - 暂停申购
    "501021",   # 华宝港股中小盘 - 暂停申购
}
